...
input_maker::input_maker(string output_file_name_in){
...
// 					logger_access->push_error(i4_err);
// 					array_size = 0;
// 				}
...
// 				logger_access->push_msg("VECTOR OF INTS AS FOLLOWS: ");
// 				for(unsigned int c = 0; c < i4_array_push_me.values.size();c++){
// 					logger_access->push_msg("\t"+to_string(i4_array_push_me.values[c]));
// 				}
...
// 			logger_access->push_msg("LINE:"+temp_string+"is an E array!");
...
// 				  array_size = stoi(temp_size_string);
// 				} catch (invalid_argument& error){
// 				  logger_access->push_error("Error in input_maker::init, real 8",
...
// 				logger_access->push_error(bad_size_msg);
// 			}
...
// 			logger_access->push_msg("Vector of R8 Doubles? As follows:");
// 			for(unsigned int c = 0; c < r8_array_push_me.values.size();c++){
// 				logger_access->push_msg(to_string(r8_array_push_me.values[c]));
// 			}
...
// 		} else {
// 			logger_access->push_error("Error! Line type wasn't determined:");
// 			logger_access->push_error(temp_string);
// 		}

// 		getline(ins,temp_string);
// 	}
// 	string im_end_msg = "########## END INPUT MAKER INIT() ##################";
// 	logger_access->push_error(im_end_msg);
// 	ins.close();
// }
...
// 	// if(tokens.size() != 4){
// 	// 	logger_access->push_error("Faulty int4 line:" + line);
// 	// 	return;
// 	// }
...
// 	// 	logger_access->push_msg("Missing '=' in I4 param declaration!");
// 	// 	return;
...
// 	// //if there aren't exactly 4 strings in the array, something is amiss
// 	// if(tokens.size() != 4){
// 	// 	logger_access->push_error("Faulty real8 line:"+line);
// 	// 	return;
// 	// }
...
// 	// 	logger_access->push_error("Missing '=' in R8 param declaration!");
// 	// 	return;
...
// 	// 	logger_access->push_error("Error while parsing config file,",
...
// // void input_maker::set_field_text_and_regex(field* field,string default_text,regex* input_test){

// // 	if (field == NULL){
// // 		string invalid_params = "set_field_text_and_regex passed NULL field pointer!";
// // 		logger_access->push_error(invalid_params);
// // 		return;
// // 	}
...
// 	logger_access->push_msg("############# PRINTING TC ########################");
// 	outs << right;
// 	for(unsigned int c = 0; c < lines_in.size();c++){
// 		logger_access->push_msg(lines_in[c]);
// 		outs << lines_in[c];
...
// 	}
// 	logger_access->push_msg("############ DONE PRINTING TC ####################");
...
//  //  } catch (out_of_range& not_found){
// 	// logger_access->push_error("Error in do_line4A: parameter not found in the map!");
//  //  }
// }
...
// 	// }
//  //  } catch (out_of_range& not_found){
// 	// logger_access->push_error("Error! Parameter in do_line4B not found in the map!");
//  //  }
// }
...
// 	// 	 << endl;
//  //  } catch (out_of_range& not_found){
// 	// logger_access->push_error("Error! Parameter in do_line6 not found in the map!");
//  //  }
// }
...
// 	// 	 << endl;
//  //  } catch (out_of_range& not_found){
// 	// logger_access->push_error("Error! Parameter in do_line7 not found in the map!");
//  //  }
...
//  //  } catch(out_of_range& not_found){
// 	// logger_access->push_error("Error! Parameter in do_line8 not found in the map!");
//  //  }
// }
...
//  //  } catch(out_of_range& not_found){
// 	// logger_access->push_error("Error! Parameter in do_line9 not found in the map!");
//  //  }
// }
