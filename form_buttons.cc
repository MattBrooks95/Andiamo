...
void icntrl10_button::init(){
	...
	my_patterns.push_back(regex_access->get_regular_expression(RE_ICNTRL10_1));
	//pattern for sub-line 2 of line 11
	my_patterns.push_back(regex_access->get_regular_expression(RE_ICNTRL10_2));
	//pattern for sub-line 3 of line 11
	my_patterns.push_back(regex_access->get_regular_expression(RE_ICNTRL10_3));
