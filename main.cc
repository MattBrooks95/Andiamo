...
//partial build command because everything is ruined
// g++ -std=c++11 main.cc system_wrapper.cc logger.cc regex_manager.cc
...
int main(int argc, char *argv[]){
	...
	//set up the parameter graphics, input checking and default values
	// string man_path = "Images/";

	// manager tile_bag(man_path,manager_config_folder);
