...
int main(){
	...
	pattern int5("\\s*-?\\s*[0-9]{1,5}\\s*","int5");
	pattern f10_3("\\s*-?\\s*[0-9]{1,6}\\s*\\.\\s*[0-9]{0,3}\\s*","f10_3");
	pattern f8_4 ("\\s*-?\\s*[0-9]{1,4}\\s*\\.\\s*[0-9]{0,4}\\s*","f8_4");
	pattern f10_4("\\s*-?\\s*[0-9]{1,5}\\s*\\.\\s*[0-9]{0,4}\\s*","f10_4");
	pattern f5_2 ("\\s*-?\\s*[0-9]{1,3}\\s*\\.\\s*[0-9]{0,2}\\s*","f5_2");
	pattern f5_1 ("\\s*-?\\s*[0-9]{1,3}\\s*\\.\\s*[0-9]{0,1}\\s*","f5_1");
	pattern f7_3 ("\\s*-?\\s*[0-9]{1,4}\\s*\\.\\s*[0-9]{0,3}\\s*","f7_3");
	...
	vector<string> test_lines = {"45", " 45 ", " 4a6", "4.56", "40000", "matthew", "123.31",
                                 " 103.3", "1000.1", "0.01.02","a", "", "0 . 0 1 . 0 3 ", 
								 "john", "13..45", ".205", "100000.342"," 500 "
								 "12345678910111213", "2 . 05", " o", "  f",
								 "11511.72934812", "-123", "123.456", " f   5",
								 "lu.ke", "19."," - 0 . 5 ","    6. 05 ", "o",
								 "-.005", "kusanagi.motoko","  17 . 76 m",
								 "79.052", "17..76", "19.95", "MYN4M3J3FF",
								 "01.2.34", "mega...deth", "a5","1842.295.", ".1393.45.223",
